...
using FunkyCode.AdventureWorks.EntityFramework.Model;

namespace FunkyCode.AdventureWorks.EntityFramework.Context
{
    public partial class AdventureWorks2016DbContext : DbContext
    {
        public AdventureWorks2016DbContext()
        {
        }

        public AdventureWorks2016DbContext(DbContextOptions<AdventureWorks2016DbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Initial Catalog=AdventureWorks2016; Integrated Security = True");
            }
        }
